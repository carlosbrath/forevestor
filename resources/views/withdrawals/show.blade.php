                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="detail-item">
                                    ...
                                    <p class="detail-value text-success fs-4">
                            ...
                            <div class="col-md-6">
                                <div class="detail-item">
                                    <label
                                        class="detail-label">{{ $withdrawal->method === 'upi' ? 'UPI ID' : 'Bank Details' }}</label>
                                    <p class="detail-value">
                    ...
                    <div class="card-body">
                        <div class="user-info-section">
                            ...
                            <div class="wallet-detail">
                                ...
                                <span
                                    class="wallet-value text-success">₹{{ number_format($withdrawal->user->wallet->withdrawable_amount ?? 0, 2) }}</span>
                            </div>

                            <div class="wallet-detail">
                                <span class="wallet-label">Total Profit</span>
                                <span
                                    class="wallet-value">₹{{ number_format($withdrawal->user->wallet->total_profit ?? 0, 2) }}</span>
                            </div>

                            <div class="wallet-detail">
                                <span class="wallet-label">Total Withdrawal</span>
                                <span
                                    class="wallet-value">₹{{ number_format($withdrawal->user->wallet->total_withdrawal ?? 0, 2) }}</span>
                            </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        <div class="alert alert-info mb-4">
                            ...
                            <ul class="mb-0 mt-2">
                                <li>Current withdrawable amount:
                                    <strong>₹{{ number_format($withdrawal->user->wallet->withdrawable_amount ?? 0, 2) }}</strong>
                                </li>
                                <li>Requested amount: <strong>₹{{ number_format($withdrawal->amount, 2) }}</strong></li>
                                <li>After approval, ₹{{ number_format($withdrawal->amount, 2) }} will be deducted from
                                    user's wallet</li>
                            </ul>
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            <!-- Approve Button -->
                            <form method="POST" action="{{ route('admin.approve-withdrawal', $withdrawal) }}"
                                class="flex-fill">
                                @csrf
                            ...
                            <!-- Reject Button -->
                            <button type="button" class="btn btn-danger btn-lg flex-fill" data-bs-toggle="modal"
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('admin.reject-withdrawal', $withdrawal) }}">
                        ...
                        <div class="modal-body">
                            <p>Are you sure you want to reject this withdrawal request of
                                <strong>₹{{ number_format($withdrawal->amount, 2) }}</strong>?
                            </p>
                            <div class="mb-3">
                                <label for="remarks" class="form-label">Rejection Reason <span

...
@section('content')
    <main class="main-content" id="mainContent">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-content">
                    ...
                    <h3 class="stat-value">₹{{ number_format($wallet->total_investment ?? 0, 2) }}</h3>
                    <div class="stat-meta">
            ...
            <div class="stat-card">
                <div class="stat-content">
                    <div class="stat-header">
                        <span class="stat-label">Withdrawable Amount</span>
                        <div class="stat-icon warning">
                            <i class="bi bi-arrow-up-right"></i>
                        </div>
                    </div>
                    <h3 class="stat-value">₹{{ number_format($wallet->withdrawable_amount ?? 0, 2) }}</h3>
                    <div class="stat-meta">
            ...
            <div class="stat-card">
                <div class="stat-content">
                    ...
                    <h3 class="stat-value">₹{{ number_format($wallet->total_profit ?? 0, 2) }}</h3>
                    <div class="stat-meta">
                        <i class="bi bi-arrow-up"></i>
            ...
            <div class="quick-recent-column">
                ...
                <div class="quick-actions-card">
                    ...
                    <div class="quick-actions-grid">
                        ...
                        <a href="#" class="quick-action-btn compound" data-bs-toggle="modal" data-bs-target="#compoundModal">
        ...
        <div class="compounds-section" style="margin-top: 2rem;">
            <div class="card-header" style="background: white; padding: 1.5rem; border-radius: 12px 12px 0 0; border-bottom: 1px solid #e5e7eb;">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="background: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                                <th style="padding: 1rem; text-align: left; font-size: 0.875rem; font-weight: 600; color: #6b7280;">#</th>
                                <th style="padding: 1rem; text-align: left; font-size: 0.875rem; font-weight: 600; color: #6b7280;">Amount</th>
                                <th style="padding: 1rem; text-align: left; font-size: 0.875rem; font-weight: 600; color: #6b7280;">Date</th>
                                <th style="padding: 1rem; text-align: left; font-size: 0.875rem; font-weight: 600; color: #6b7280;">Remark</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal-content" style="border-radius: 12px; border: none; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
                ...
                <form action="{{ route('compound') }}" method="POST">
                    ...
                    <div class="modal-body" style="padding: 1.5rem;">
                            ...
                            <div style="display: flex; align-items: start; gap: 0.75rem;">
                                ...
                                <div style="flex: 1;">
                                    <p style="margin: 0; color: #78350f; font-size: 0.875rem; line-height: 1.5;">
                                        <strong>Available Profit:</strong> ₹{{ number_format($wallet->total_profit ?? 0, 2) }}
                                    </p>
                                    <p style="margin: 0.5rem 0 0 0; color: #78350f; font-size: 0.875rem;">
                                        You can compound any amount up to your total profit. The compounded amount will be added to your investment.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="compound_amount" class="form-label" style="font-weight: 500; color: #374151; margin-bottom: 0.5rem;">
                            ...
                            <div class="input-group">
                                ...
                                <input
                                    type="number"
                                    class="form-control @error('compound_amount') is-invalid @enderror"
                                    id="compound_amount"
                                    name="compound_amount"
                                    step="0.01"
                                    min="1"
                                    max="{{ $wallet->total_profit ?? 0 }}"
                                    placeholder="Enter amount to compound"
                                    required
                                    style="border-left: 0;"
                                >
                            </div>
                        ...
                        <div style="background: #f0fdf4; border: 1px solid #86efac; border-radius: 8px; padding: 1rem; margin-top: 1rem;">
                            <div style="display: flex; align-items: start; gap: 0.75rem;">
                                <i class="bi bi-check-circle" style="color: #16a34a; font-size: 1.25rem;"></i>
                                <div style="flex: 1;">
                                    <p style="margin: 0; color: #14532d; font-size: 0.875rem; font-weight: 500;">What happens next?</p>
                                    <ul style="margin: 0.5rem 0 0 0; padding-left: 1.25rem; color: #166534; font-size: 0.875rem; line-height: 1.6;">
                    ...
                    <div class="modal-footer" style="border-top: 1px solid #e5e7eb; padding: 1rem 1.5rem; background: #f9fafb;">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="padding: 0.5rem 1rem; border-radius: 6px;">Cancel</button>
                        <button type="submit" class="btn btn-primary" style="background: #b8860b; border: none; padding: 0.5rem 1.5rem; border-radius: 6px;">

                ...
                <tbody>
                    @forelse($investments as $investment)
                        <tr>
                            ...
                            <td>
                                @if($investment->status === 'pending')
                                    <form action="{{ route('admin.approve-investment', $investment->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-success" title="Approve">
                                            <i class="bi bi-check-circle"></i>
                                        </button>
                                    </form>
                                    <form action="{{ route('admin.reject-investment', $investment->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-danger" title="Reject" onclick="return confirm('Are you sure you want to reject this investment?')">

        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-5">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="login-subtitle" style="color: var(--color-text-secondary); margin-bottom: 0;">Sign in to your Forevestor account to manage your investments</p>
                </div>
                ...
                <form id="loginForm" method="POST" action="{{ route('login.submit') }}" class="login-form">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="rememberMe" style="color: var(--color-text-secondary);">
                                Remember me
                            </label>
                        </div>
                        <a href="" class="forgot-password-link" style="color: var(--color-primary); font-weight: 500; font-size: var(--fs-sm);">Forgot password?</a>
                    </div>
                    ...
                    <div class="text-center mb-4">
                        <p style="color: var(--color-text-secondary);">
                            ...
                            <a href="{{ route('register') }}" style="color: var(--color-primary); font-weight: 600;">Create one now</a>
                        </p>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <button type="button" class="btn btn-outline btn-lg social-btn" style="border-color: var(--color-border-primary); color: var(--color-text-primary);">
                ...
                <!-- Security Notice -->
                <div class="security-notice mt-5 p-3" style="background-color: var(--color-bg-light); border-radius: var(--radius-sm); border-left: 4px solid var(--color-primary);">
                    <div style="display: flex; gap: var(--spacing-md); align-items: flex-start;">
                        <i class="bi bi-shield-check" style="color: var(--color-primary); font-size: 1.2rem; flex-shrink: 0;"></i>
                        <div>
                            <p class="fw-600 mb-2" style="color: var(--color-text-primary);">Secure Login</p>
                            <p class="mb-0" style="color: var(--color-text-secondary); font-size: var(--fs-sm);">Your account is protected with industry-standard encryption. Never share your password with anyone.</p>
                        </div>
                    </div>
                </div>

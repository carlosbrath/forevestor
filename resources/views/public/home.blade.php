    ...
    <div class="d-flex flex-column align-items-center gap-3">
        ...
        <div class="d-flex gap-3 justify-content-center flex-wrap hero-cta">
            <a href="#" class="btn btn-primary btn-lg"
                style="background-color: var(--color-primary); border-color: var(--color-primary); color: white; font-weight: 600;">Get
                Started</a>
            <a href="#" class="btn btn-outline btn-lg"
                style="color: var(--color-text-primary); border-color: var(--color-primary); border-width: 2px;">Learn
                More</a>
        </div>
    </div>

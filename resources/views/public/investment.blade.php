        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="investment-subtitle" style="color: var(--color-text-secondary); margin-bottom: 0;">Invest in projects and grow your wealth with Forevestor</p>
                </div>

                <!-- Investment Form -->
                <form id="investmentForm" method="POST" action="{{ route('investments.store') }}" enctype="multipart/form-data" class="investment-form">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="number" class="form-control @error('investment_amount') is-invalid @enderror" id="investmentAmount" name="investment_amount" placeholder="e.g., 5000" min="500" step="100" value="{{ old('investment_amount') }}" required>
                        </div>
                        <small class="form-text" style="color: var(--color-text-secondary);">Minimum investment amount: ₹500</small>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select form-control-lg @error('payment_method') is-invalid @enderror" id="paymentMethod" name="payment_method" required>
                            ...
                            <option value="upi_gpay" {{ old('payment_method') == 'upi_gpay' ? 'selected' : '' }}>UPI (GPay/PhonePe/Paytm)</option>
                            ...
                            <option value="neft_rtgs" {{ old('payment_method') == 'neft_rtgs' ? 'selected' : '' }}>NEFT/RTGS</option>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg @error('upi_or_bank') is-invalid @enderror" id="upiOrBank" name="upi_or_bank" placeholder="rohan@ybl or HDFC Bank" value="{{ old('upi_or_bank') }}" required>
                        @error('upi_or_bank')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-lg @error('transaction_id') is-invalid @enderror" id="transactionId" name="transaction_id" placeholder="UPI12345XXXX or IMPS8765XXXX" value="{{ old('transaction_id') }}" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            <span class="input-group-text">₹</span>
                            <input type="number" class="form-control @error('paid_amount') is-invalid @enderror" id="paidAmount" name="paid_amount" placeholder="e.g., 5000" min="500" step="100" value="{{ old('paid_amount') }}" required>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control form-control-lg @error('notes') is-invalid @enderror" id="notes" name="notes" placeholder="e.g., 'Paid via Google Pay at 4 PM'" rows="4" style="resize: vertical;">{{ old('notes') }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="text-center">
                        <p style="color: var(--color-text-secondary);">
                            Want to go back?
                            <a href="{{ route('dashboard') }}" style="color: var(--color-primary); font-weight: 600;">Back to Dashboard</a>
                        </p>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (paymentMethodSelect) {
            paymentMethodSelect.addEventListener('change', function() {
                ...
                if (method === 'upi_gpay' || method === 'bhim_upi' || method === 'imps' || method === 'neft_rtgs' || method === 'net_banking') {
